  ...
  const portfolioItems: PortfolioItem[] = [
    {
      ...
      images: [OfflineOperationImage]
    },
    {
      id: "2", 
      src: IntegratedOperationImage,
      alt: "온·오프라인 통합 운영 - 대형 강의실에서 하이브리드 행사 진행",
      title: "온·오프라인 통합 운영",
      subtitle: "하이브리드 행사 기술 지원",
      ...
      images: [IntegratedOperationImage]
    },
    {
      id: "3",
      src: TechSupportImage,
      alt: "현장 기술 대응 - HDMI 분배기 및 각종 기술 장비 설정", 
      title: "현장 기술 대응",
      subtitle: "실시간 장비 관리 및 문제 해결",
    ...
    },
    {
      ...
      alt: "해외법인 초청 이벤트 - 국제 비즈니스 프로그램 진행",
      title: "해외법인 초청 이벤트", 
      subtitle: "국제 비즈니스 프로그램 운영",
      ...
      images: [OverseasEventImage]
    },
    {
      id: "5",
      src: OnlineEventImage,
      alt: "온라인 이벤트 기획 - 가상 아바타를 활용한 온라인 이벤트",
      title: "온라인 이벤트 기획",
      subtitle: "가상 환경 활용 디지털 콘텐츠",
