  ...
  const portfolioItems: PortfolioItem[] = [
    {
      ...
      description: "삼성 그룹의 온라인과 오프라인을 연계한 통합 교육 프로그램을 기획하고 운영했습니다. 실시간 스트리밍 기술과 현장 진행을 결합하여 참여자 만족도를 크게 향상시켰습니다.",
    ...
    },
    {
      ...
      description: "온라인 학습 플랫폼을 위한 프리미엄 교육 영상 콘텐츠를 제작했습니다. 복잡한 학습 내용을 쉽게 이해할 수 있도록 애니메이션과 인터랙티브 요소를 활용했습니다.",
    ...
    },
    {
      ...
      description: "기업 교육을 위한 맞춤형 콘텐츠를 기획하고 제작했습니다. 실무 중심의 교육 과정과 영상 자료를 통해 효과적인 학습 환경을 구축했습니다.",
    ...
    },
    {
      ...
      description: "항공사의 해외 노선 프로모션을 위한 마케팅 콘텐츠를 제작했습니다. 현지 인플루언서와 협업하여 브랜드의 매력을 효과적으로 전달하는 영상을 기획했습니다.",
