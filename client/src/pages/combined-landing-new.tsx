          ...
          <div className="flex flex-col justify-center items-center min-h-screen text-center mt-[-91px] mb-[-91px] pl-[0px] pr-[0px]">
            ...
            >
              <div className="space-y-2">
                <div className="block text-[62px] mt-[18px] mb-[18px]">메세지를 넘어</div>
                <div className="block text-[62px] mt-[18px] mb-[18px]">시청자의 경험까지</div>
                ...
                <div className="block mt-[0px] mb-[0px] text-[62px]">콘텐츠 제작자 이승훈 입니다<span className="text-pink-500">.</span></div>
              </div>
            </motion.h1>
